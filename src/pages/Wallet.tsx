...
const Wallet = () => {
  ...
  useEffect(() => {
    const fetchWallet = async () => {
      if (!user) return;
      const response = await fetch("https://patuvest.azurewebsites.net/api/wallet", {
  ...
  const handleFund = async (e: React.FormEvent) => {
    ...
    setFundSuccess(null);
    setLoading(true);
    const response = await fetch("https://patuvest.azurewebsites.net/api/wallet/fund", {
      method: "POST",
      headers: {
  ...
  const handleWithdraw = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const response = await fetch("https://patuvest.azurewebsites.net/api/wallet/withdraw", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${user.token}`,
